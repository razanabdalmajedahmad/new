...
@section('min')
    ...
    <div class="container-xxl mt-5 border border-dark">
        <form id="form1">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xxl-4 mt-5 mb-5">
                <div class="col">
                    ...
                    <input type="text" class="form-control" value="{{$Invoice->name}}" placeholder="Inventory Name" name="name">
                    <input type="text" class="form-control" value="{{$Invoice->id}}" placeholder="Inventory Name" name="Invoiceid" hidden>

                </div>
                <div class="col">
                    <label  class="form-label">Inventory Code</label>
                    <input type="text" class="form-control" value="{{$Invoice->code}}" placeholder="Inventory Code" name="code">
                </div>
                <div class="col">
                    <label  class="form-label">Inventory Date</label>
                    <input type="text" class="form-control" value="{{$Invoice->date}}" placeholder="Inventory Date" name="date">
                </div>
                <div class="col">
                    <label  class="form-label">Inventory Namber</label>
                    <input type="text" class="form-control" value="{{$Invoice->namber}}" placeholder="Inventory Namber" name="namber" >
                </div>
            </div>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xxl-4 mt-5 mb-5">
                <div class="col">
                    <label  class="form-label">Company Name</label>
                    <input type="text" class="form-control" value="{{$Invoice->company_name}}" placeholder="Company Name" name="company_name" >
                </div>
                <div class="col">
                    <label  class="form-label">Customer Name</label>
                    <input type="text" class="form-control"  value="{{$Invoice->customer_name}}" placeholder="Company Name" name="customer_name" >
                </div>
                <div class="col">
                    <label  class="form-label">Customer Address</label>
                    <input type="text" class="form-control" value="{{$Invoice->customer_address}}"  placeholder="Customer Address" name="customer_address" >
                </div>
                <div class="col">
                    <label  class="form-label">Customer Email</label>
                    <input type="email" class="form-control" value="{{$Invoice->customer_email}}" placeholder="Customer Email" name="customer_email" >
                </div>
            </div>


        <div class="row m-5" id="table_div">
            ...
            <div class="table-responsive">
                <table class="table align-middle" id="table">
                    ...
                    <tbody>
                        ...
                        <tr class="table_row" id="{{$i}}">
                            <td >
                                <button id="Delete" data-id="{{$i}}" type="button" class=" Delete btn btn-danger mr-1">Delete</button>
                                <button id="Edit" data-id="{{$i}}" type="button" class=" Edit btn btn-info ">Edit</button>
                            </td>
                            <td>
                                <textarea name="item_description[{{$i}}]" cols="30" class="form-control" placeholder="Write your Description"readonly >{{$key->description}}</textarea>
                            </td>
                            <td>
                                <input type="text" class="form-control"value="{{$key->name}}" placeholder="Item Name" name="item_name[{{$i}}]"readonly  >
                            </td>
                            <td>
                                <input type="number" class="form-control" value="{{$key->qty}}" placeholder="Item qty" name="item_qty[{{$i}}]"readonly  >
                            </td>
                            <td>
                                <input type="number" class="form-control" value="{{$key->price}}" placeholder="Item price" name="item_price[{{$i}}]" readonly >
                            </td>
                            <td>
                                <input type="number" class="form-control" value="{{$key->total}}" placeholder="Total price" name="total_price[{{$i}}]" readonly >
                            </td>
                        </tr>
                        <div hidden>
                            {{$i++}}
        ...
        <div class="row mt-5 mb-5" id="create-div" >
            <div class="col text-center">
                <button id="create" type="button" class="btn btn-warning">update Invoice</button>
            </div>
